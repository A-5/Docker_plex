...
cp ./data/tuners.yml ~/docker/docker-mirakurun-epgstation/Mirakurun/config/tuners.yml
cp ./data/channels.yml ~/docker/docker-mirakurun-epgstation/Mirakurun/config/channels.yml
cp ./data/new-docker-compose.yml ~/docker/docker-mirakurun-epgstation/docker-compose.yml
